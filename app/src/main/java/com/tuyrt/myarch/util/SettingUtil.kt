...
object SettingUtil {
    ...
    fun getColor(context: Context): Int {
        ...
        val defaultColor = ContextCompat.getColor(context, R.color.color_theme)
    ...
    fun getColorStateList(context: Context): ColorStateList {
        val colors = intArrayOf(getColor(context), ContextCompat.getColor(context, R.color.color_333))
    ...
    fun getColorStateList(color: Int): ColorStateList {
        val colors = intArrayOf(color, ContextCompat.getColor(AppGlobals.get(), R.color.color_333))
        val states = arrayOfNulls<IntArray>(2)
        states[0] = intArrayOf(android.R.attr.state_checked, android.R.attr.state_checked)
        states[1] = intArrayOf()
        return ColorStateList(states, colors)
