package com.tuyrt.architecture.capacity.log;
...
public final class KLog {
    ...
    private static final String TAG_DEFAULT = "KLog"; // 默认tag：为类名
    ...
    public static void dt(String tag,  @NonNull Object... objects) {
    ...
    public static void it(String tag,  @NonNull Object... objects) {
    ...
    private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
        ...
        if (mIsGlobalTagEmpty && TextUtils.isEmpty(tag)) {
            tag = TAG_DEFAULT;
        }else if (!mIsGlobalTagEmpty && TextUtils.isEmpty(tag)) {
            tag = mGlobalTag;
        }
